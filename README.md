# Repository: 2018-01.project-4.template
# Assignment #4: SQL  
...
### Description
This is the **fourth assignment** for the CS 1656 -- Introduction to Data Science (CS 2056) class, for the Spring 2018 semester.
...
* **[Q01]** List all the actors (first and last name) who acted in at least one film in the 80s (1980-1990, both ends inclusive) and in at least one film in the 21st century (>=2000).  
...
sys
```
If you would like to use any other libraries, you must ask permission by Thursday, April 5, 2018, using [piazza](http://piazza.cs1656.org).
...
* the day of the deadline **Friday, April 13, 2018 (i.e., at 12:15am, Saturday, April 14, 2018)**  
